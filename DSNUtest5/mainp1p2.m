...
%x=real
%y=aax^2+ax+b1+b2+b3;
aa2 = zeros(2, PIC_MAX_COL);
a2 = zeros(2, PIC_MAX_COL);
b12 = zeros(2, PIC_MAX_COL);
b22 = 0;
b32 = zeros(2, PIC_MAX_COL);
...
for i = 1 : nbpics
    ...
    b12(1, :) = b12(1, :) + mean(tmp_I_pt1);
    b12(2, :) = b12(2, :) + mean(tmp_I_pt2);
end
b12 = b12 / nbpics;
...
for i = 1 : nlpics
    ...
    [x_list_i, y_list_i] = img_data_generator(tmp_I, b12, b22,...
...
%     a(1, i) = tmp_para(2);
%     b3(1, i) = tmp_para(3);
    tmp_para = createFit_p1p2(x_list_u(:, i), y_list_u(:, i));
    %aa2(1, i) = tmp_para.p1;
    a2(1, i) = tmp_para.p1;
    b32(1, i) = tmp_para.p2;
...
%     a(2, i) = tmp_para(2);
%     b3(2, i) = tmp_para(3);
    tmp_para = createFit_p1p2(x_list_d(:, i), y_list_d(:, i));
    %aa2(2, i) = tmp_para.p1;
    a2(2, i) = tmp_para.p1;
    b32(2, i) = tmp_para.p2;
    if(mod(i,100) == 0)
...
%save
save('DSNU_31_p1p2_robust.mat','a2','b12','b22','b32');

if(1)
    ax = x_list_u(:,1736);
    ay = y_list_u(:,1736);
    plot(x_list_u(:,1736),y_list_u(:,1736) + b12(1,1736) + b22 ,'+');
    hold on;
    x = 0:5000:50000;
    y = polyval([aa2(1,1736),a2(1,1736),b12(1,1736) + b22 + b32(1,1736)],x);
    plot(x,y);
end
